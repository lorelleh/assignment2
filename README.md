...
|--------|-------|-------------|
| **ATE RMSE** | **2.3346 m** | Global accuracy after Sim(3) alignment (scale corrected)  |
| **RPE Trans Drift** | **1.6310 m/m** | Translation drift rate (mean error per meter, delta=10 m) |
| **RPE Rot Drift** | **106.7148 deg/100m** | Rotation drift rate (mean angle per 100 m, delta=10 m) |
...
Matched Poses: 1,565 / 1,955 (80.05%)  ← Completeness
...
| **Association rate (Completeness)** | 80.05% |

### Performance Analysis

| Metric | Value | Grade | Interpretation |
|--------|-------|-------|----------------|
| **ATE RMSE** | 2.33 m | A | Very small global error after alignment, high global accuracy |
| **RPE Trans Drift** | 1.63 m/m | B | Acceptable local translation drift per distance |
| **RPE Rot Drift** | 106.71 deg/100m | C | Moderate rotation drift, no severe orientation error |
| **Completeness** | 80.05% | B | Most poses can be successfully evaluated |
...
1698132964.599975824 -0.019782109 0.016437741 -0.096232727 -0.004741336 0.012213998 0.001252113 0.999913394
1698132964.899988890 -0.080118224 0.055677798 -0.400852740 -0.008196500 0.023159508 0.004982300 0.999685764
...
```
